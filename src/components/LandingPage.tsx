...
export default function BackgroundBoxesDemo() {
  return (
    <div className="h-[40rem] md:h-[40rem]  relative w-full  overflow-hidden bg-slate-900 flex flex-col items-center justify-center ">
      <div className="absolute inset-0 w-full h-full bg-black z-20 [mask-image:radial-gradient(transparent,white)] pointer-events-none" />

      <div className="relative md:-mt-0 mt-5 flex rounded-full p-[4px] mx-auto border z-40 border-white/10  bg-gradient-to-r  from-transparent via-slate-900 to-black w-[13rem] lg:w-[13.5rem] place-content-center ">
             <Image 
                  src={thumpup}
                  alt="star_image"
                  width="100"
